...
A [development container](https://containers.dev/) is a Docker-based environment that provides a consistent, reproducible development setup. Benefits:
...
The devcontainer handles all of this automatically - open the project in VS Code and start coding.
...
4. Access Ghost Admin at http://localhost:3001/ghost/ with auto-created credentials (`admin@example.com` / `RandomSecure123456789`)
...
Ghost runs automatically when the devcontainer starts. Theme changes are live-mounted and auto-detected.
